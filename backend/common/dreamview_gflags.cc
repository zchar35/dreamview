...
DEFINE_string(hmi_config_filename, "/jmcauto/modules/dreamview/conf/hmi.conf",
              "The HMI config file");
...
DEFINE_string(static_file_dir, "modules/dreamview/frontend/dist",
              ...
              "value points to built-in version from the JmcAuto project.");

DEFINE_string(server_ports, "8889",
