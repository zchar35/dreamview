...
using jmc_auto::common::math::HeadingToQuaternion;
 ...
 public:
  SimControlTest() {
    ...
    config.set_is_ros(false);
    {
      ...
      sub_config->set_mode(
          jmc_auto::common::adapter::AdapterConfig::PUBLISH_ONLY);
...

    {
      ...
      sub_config->set_mode(
          jmc_auto::common::adapter::AdapterConfig::PUBLISH_ONLY);
      sub_config->set_type(
          jmc_auto::common::adapter::AdapterConfig::LOCALIZATION);
    }

    {
      auto *sub_config = config.add_config();
      sub_config->set_mode(
          jmc_auto::common::adapter::AdapterConfig::RECEIVE_ONLY);
      sub_config->set_type(
          jmc_auto::common::adapter::AdapterConfig::PLANNING_TRAJECTORY);
    }

    {
      ...
      sub_config->set_mode(
          jmc_auto::common::adapter::AdapterConfig::RECEIVE_ONLY);
      sub_config->set_type(
          jmc_auto::common::adapter::AdapterConfig::ROUTING_RESPONSE);
    }

    {
      ...
      sub_config->set_mode(
          jmc_auto::common::adapter::AdapterConfig::RECEIVE_ONLY);
      sub_config->set_type(jmc_auto::common::adapter::AdapterConfig::NAVIGATION);
    }
...
TEST_F(SimControlTest, Test) {
...

  {
    ...
    const auto timestamp = jmc_auto::common::time::From(100.01);
