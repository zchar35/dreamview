...
using jmc_auto::common::Header;
using jmc_auto::common::Point3D;
using jmc_auto::common::Quaternion;
...
using jmc_auto::common::math::InverseQuaternionRotate;
using jmc_auto::common::math::InterpolateUsingLinearApproximation;
using jmc_auto::common::math::NormalizeAngle;
using jmc_auto::common::math::QuaternionToHeading;
...
void SimControl::OnPlanning(const jmc_auto::planning::ADCTrajectory& trajectory) {
  if (!enabled_) {
    return;
  }
