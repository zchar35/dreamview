...
HMI::HMI(WebSocketHandler *websocket, MapService *map_service)
    : websocket_(websocket),
      ...
      logger_(jmc_auto::common::monitor::MonitorMessageItem::HMI) {
...
void HMI::RegisterMessageHandlers() {
  ...
  websocket_->RegisterMessageHandler(
      ...
      [this](const Json &json, WebSocketHandler::Connection *conn) {
        ...
        if (JsonUtil::GetStringFromJson(json, "data", &data)) {
          ...
          request.set_wav_stream(jmc_auto::common::util::Base64Decode(data));
  ...
  websocket_->RegisterMessageHandler(
      ...
      [this](const Json &json, WebSocketHandler::Connection *conn) {
        ...
        jmc_auto::common::monitor::MonitorLogBuffer log_buffer(&logger_);
