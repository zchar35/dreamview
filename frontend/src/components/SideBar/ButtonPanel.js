...
import Remote5GIcon from "assets/images/sidebar/data_recorder.png";
    ...
    render() {
        ...
        return (
            <div className="main-panel">
                ...
                <SideBarButton label="5G remote"
                               disabled={settings.showRemote5G.disabled}
                               iconSrc={Remote5GIcon}
                               onClick={settings.showRemote5G.onClick}
                               active={settings.showRemote5G.active} />
            </div>
        );
    }
}
