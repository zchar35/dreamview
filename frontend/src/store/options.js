...
export default class Options {
    ...
    @observable showRemote5G = PARAMETERS.options.defaults.showRemote5G;//曾体伟
    ...
    mainSideBarOptions = ['showTasks', 'showModuleController',
        'showMenu', 'showRouteEditingBar', 'showDataRecorder','showRemote5G'];//曾体伟
    ...
    //曾体伟
    BatchAddToBasket() {
        alert("diaoyongchenggong");
        // let questionNums = '';
        // const checkboxs = document.getElementsByName('question');
